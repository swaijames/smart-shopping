...
<head>
    ...
    <!--title  -->
    <title>SmartShopping | About Us</title>
...
<body>
                ...
                <div class="row align-items-center gy-5">
                    <div class="col-lg-6">
                        <div class="about-img" data-aos="fade-right">
                            <img src="./assets/images/core/about/about-img-1.webp" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                                    ...
                                    <li>
                                        <span>
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="12.5" cy="12.5" r="12.5" fill="#00a1d2" />
                                                <path
                    ...
                    <div class="wrapper-img">
                        <span>
                            <svg width="104" height="104" viewBox="0 0 104 104" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <circle cx="52" cy="52" r="52" fill="#00a1d2" />
                                <path
    ...
    <div class="about-promotion">
        <a href="assets/images/core/about/advertrisement-vedio.mp4" target="_blank" class="about-btn">
            <span>
        ...
        <video src="./assets/images/core/about/advertrisement-vedio.mp4" autoplay loop muted></video>
    </div>
    <!--------------- about-promotion-end---------------->
                ...
                <div class="swiper about-swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide testimonial-wrapper">
                            ...
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="./assets/images/core/about/testimonial-img-1.webp" alt="img">
                                </div>
                        ...
                        <div class="swiper-slide testimonial-wrapper">
                            ...
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="./assets/images/core/about/testimonial-img-2.webp" alt="img">
                                </div>
                                <div class="testimonial-info-details">
                        ...
                        <div class="swiper-slide testimonial-wrapper">
                            ...
                            <div class="testimonial-info">
                                <div class="testimonial-img">
                                    <img src="./assets/images/core/about/testimonial-img-3.webp" alt="img">
                                </div>
                                <div class="testimonial-info-details">
